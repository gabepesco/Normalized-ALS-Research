...
def main():
    ...
    pl_names, pl_followers, track_uris, track_titles = parserfunctions.get_dataset_info()
    print('Loaded info.')

    pref_matrix = parserfunctions.get_pref_matrix(track_uris)
    print('Loaded pref_matrix.')

    print('Generating shuffled data...')
    shuffled_pref_matrix, shuffled_pl_names, shuffled_pl_followers = parserfunctions.get_shuffled_data(pref_matrix, pl_names, pl_followers)
    ...
    sorted_pref_matrix, sorted_track_uris, sorted_track_titles = parserfunctions.get_sorted_data(shuffled_pref_matrix, track_uris, track_titles)
    ...
    bm25_conf_matrix = parserfunctions.get_bm25_conf_matrix(sorted_pref_matrix)
    ...
    tfidf_conf_matrix = parserfunctions.get_tfidf_conf_matrix(sorted_pref_matrix)
    ...
    bm25_len_norm_conf_matrix = parserfunctions.get_bm25_len_norm_conf_matrix(sorted_pref_matrix)
    ...
    optimized_conf_matrix = parserfunctions.get_optimized_conf_matrix(shuffled_pref_matrix, bm25_conf_matrix, shuffled_pl_followers)
